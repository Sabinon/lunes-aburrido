namespace SpriteKind {
    export const llama = SpriteKind.create()
    export const Moneda = SpriteKind.create()
}
function llamas2 () {
    for (let value of tiles.getTilesByType(sprites.dungeon.darkGroundNorthWest0)) {
        llamas = sprites.create(sprites.dungeon.darkGroundNorthWest0, SpriteKind.llama)
        tiles.placeOnTile(llamas, value)
        ...
        [img`
            ...
            . . . . . . 2 4 4 4 4 . 2 . . . 
            . . . . 2 2 2 4 5 2 4 2 . . . . 
            . . 4 2 5 5 5 4 4 5 4 4 . 4 4 . 
            . 5 4 2 4 5 5 4 4 5 2 4 4 4 2 . 
            5 4 5 4 2 5 5 4 2 5 5 4 5 4 4 2 
            5 4 4 2 2 4 2 4 4 5 2 4 4 2 5 2 
            2 5 2 4 4 2 2 5 4 4 4 2 5 2 4 5 
            `,img`
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . 5 . . . . . . 
            . . . . . . . 5 . . . . . . . . 
            ...
            . . . . . . . . . 4 4 5 5 . . . 
            . . . 5 5 2 5 . 4 5 4 2 2 2 . . 
            . . 5 4 4 2 4 2 2 4 5 5 . 5 . 2 
            5 . 5 2 4 4 4 4 2 2 4 5 4 5 . 5 
            . 2 5 4 5 5 4 5 4 5 5 5 2 4 4 4 
            2 2 2 4 4 4 2 4 4 5 4 4 2 4 2 4 
            4 4 4 5 4 4 4 4 4 4 4 4 5 4 4 2 
            `,img`
            . . . . . . . 5 . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . 4 . . . . . . 
            ...
            . . . . . . 4 2 4 4 4 4 5 . . . 
            . . 5 . 2 2 4 5 4 4 5 4 4 . . . 
            5 . . 4 4 4 2 4 4 2 4 4 4 . . . 
            . . 4 5 5 2 4 4 4 4 4 4 5 4 . 5 
            5 . 4 4 4 2 4 2 5 4 2 4 4 5 2 4 
            2 2 4 2 4 4 4 5 4 4 4 4 4 4 4 5 
            5 2 5 4 5 4 4 2 4 4 5 5 2 4 5 2 
            `],
        800,
        true
        )
...
function monedas () {
    for (let value of tiles.getTilesByType(sprites.dungeon.collectibleRedCrystal)) {
        Monedota = sprites.create(img`
            ...
            . . . . . . . . . . . . . . . . 
            `, SpriteKind.Moneda)
        tiles.placeOnTile(Monedota, value)
        animation.runImageAnimation(
        Monedota,
        [img`
            . . . . . . . . . . . . . . . . 
...
let Monedota: Sprite = null
let llamas: Sprite = null
let añaña: Sprite = null
scene.setBackgroundImage(img`
    ...
    `)
scroller.scrollBackgroundWithSpeed(-0.5, 0)
añaña = sprites.create(img`
    ........................
    ........................
    ........................
    ........................
    ...
    ........................
    `, SpriteKind.Player)
controller.moveSprite(añaña, 120, 0)
tiles.setCurrentTilemap(tilemap`nivel1`)
info.setLife(5)
scene.cameraFollowSprite(añaña)
inicial()
llamas()
